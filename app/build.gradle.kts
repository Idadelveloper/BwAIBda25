...
android {
    namespace = "com.example.bwaibda25"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.bwaibda25"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation(platform(libs.androidx.compose.bom.v20240500)) // Or latest BOM
...
// Coroutines (for ViewModel async operations)
